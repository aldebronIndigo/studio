...
import 'payment_note_model.dart';
export 'payment_note_model.dart';
...
class _PaymentNoteWidgetState extends State<PaymentNoteWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentNoteModel());
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await PaymentDetailsRecord.createDoc(
                                                  widget.refClub!.reference)
                                              .set(
                                                  createPaymentDetailsRecordData(
                                            createdAt: getCurrentTimestamp,
                                            paymentMode:
                                                _model.paymentTypeValue,
                                            payee: widget.refMember?.reference,
                                          ...
                                          await widget.refMember!.reference
                                            ...
                                            ...createMembersClubRecordData(
                                              triyomPoints: widget
                                                      .refMember!.triyomPoints +
                                                  (_model.points!),
                                              triyomCoins: widget
                                                      .refMember!.triyomCoins +
                                                  (_model.coins!),
                                              amountPaid: widget
                                                      .refMember!.amountPaid +
                                                  (_model.amount!),
                                            ),
                                            ...mapToFirestore(
                                              {
                                                'notes': FieldValue.arrayUnion([
                                                  getPaymentNotesFirestoreData(
                                                    createPaymentNotesStruct(
                                                      date: getCurrentTimestamp,
                                                      amount: _model.amount,
                                                      mode: _model.stateValue,
                                                      memberRef: widget
                                                          .refMember?.reference,
                                                      coins: _model.coins,
                                                      points: _model.points,
