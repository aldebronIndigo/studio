...
import 'dropdown_main_menu_model.dart';
export 'dropdown_main_menu_model.dart';

class DropdownMainMenuWidget extends StatefulWidget {
  const DropdownMainMenuWidget({super.key});

  @override
  State<DropdownMainMenuWidget> createState() => _DropdownMainMenuWidgetState();
}

class _DropdownMainMenuWidgetState extends State<DropdownMainMenuWidget> {
  late DropdownMainMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropdownMainMenuModel());
  }
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(16.0, 66.0, 16.0, 16.0),
        child: Container(
          width: 300.0,
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(Paywall1Widget.routeName);
                          },
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
