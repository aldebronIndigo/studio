...
class GeneralContestsRecord extends FirestoreRecord {
  GeneralContestsRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('generalContests')
          : FirebaseFirestore.instance.collectionGroup('generalContests');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('generalContests').doc(id);

  static Stream<GeneralContestsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => GeneralContestsRecord.fromSnapshot(s));

  static Future<GeneralContestsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => GeneralContestsRecord.fromSnapshot(s));

  static GeneralContestsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      GeneralContestsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static GeneralContestsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      GeneralContestsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'GeneralContestsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is GeneralContestsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createGeneralContestsRecordData({
  DateTime? createdAt,
  DateTime? endDate,
  String? title,
  String? description,
...
class GeneralContestsRecordDocumentEquality
    implements Equality<GeneralContestsRecord> {
  const GeneralContestsRecordDocumentEquality();

  @override
  bool equals(GeneralContestsRecord? e1, GeneralContestsRecord? e2) {
  ...
  @override
  int hash(GeneralContestsRecord? e) => const ListEquality().hash([
        e?.createdAt,
        e?.endDate,
        e?.title,
        e?.description,
  ...
  @override
  bool isValidKey(Object? o) => o is GeneralContestsRecord;
}
