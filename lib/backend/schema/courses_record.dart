...
class CoursesRecord extends FirestoreRecord {
  ...
  // "activeMemberList" field.
  List<DocumentReference>? _activeMemberList;
  List<DocumentReference> get activeMemberList => _activeMemberList ?? const [];
  bool hasActiveMemberList() => _activeMemberList != null;
  ...
  void _initializeFields() {
    ...
    _activeMemberList = getDataList(snapshotData['activeMemberList']);
  }
...
class CoursesRecordDocumentEquality implements Equality<CoursesRecord> {
  ...
  bool equals(CoursesRecord? e1, CoursesRecord? e2) {
    ...
    return e1?.createdAt == e2?.createdAt &&
        ...
        listEquality.equals(e1?.activeMemberList, e2?.activeMemberList);
  }
