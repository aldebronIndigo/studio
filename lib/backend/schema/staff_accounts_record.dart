...
class StaffAccountsRecord extends FirestoreRecord {
  ...
  // "leadNumbers" field.
  int? _leadNumbers;
  int get leadNumbers => _leadNumbers ?? 0;
  bool hasLeadNumbers() => _leadNumbers != null;
  ...
  void _initializeFields() {
    ...
    _leadNumbers = castToType<int>(snapshotData['leadNumbers']);
  }

  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('staffAccounts')
          : FirebaseFirestore.instance.collectionGroup('staffAccounts');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('staffAccounts').doc(id);
...
class StaffAccountsRecordDocumentEquality
  ...
  bool equals(StaffAccountsRecord? e1, StaffAccountsRecord? e2) {
    ...
    return e1?.refUser == e2?.refUser &&
        ...
        e1?.leadNumbers == e2?.leadNumbers;
  }

  @override
  int hash(StaffAccountsRecord? e) => const ListEquality().hash([
        e?.refUser,
        e?.refClub,
        e?.role,
        e?.designation,
