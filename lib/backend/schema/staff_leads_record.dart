...
class StaffLeadsRecord extends FirestoreRecord {
  StaffLeadsRecord._(
  ...
  void _initializeFields() {
    ...
    _refStaff = snapshotData['refStaff'] as DocumentReference?;
  }

  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('staffLeads')
          : FirebaseFirestore.instance.collectionGroup('staffLeads');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('staffLeads').doc(id);

  static Stream<StaffLeadsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => StaffLeadsRecord.fromSnapshot(s));

  static Future<StaffLeadsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => StaffLeadsRecord.fromSnapshot(s));

  static StaffLeadsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      StaffLeadsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static StaffLeadsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      StaffLeadsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'StaffLeadsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is StaffLeadsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createStaffLeadsRecordData({
...
class StaffLeadsRecordDocumentEquality implements Equality<StaffLeadsRecord> {
  const StaffLeadsRecordDocumentEquality();

  @override
  bool equals(StaffLeadsRecord? e1, StaffLeadsRecord? e2) {
    ...
    return e1?.refClub == e2?.refClub &&
        ...
        e1?.refStaff == e2?.refStaff;
  }

  @override
  int hash(StaffLeadsRecord? e) => const ListEquality().hash([
        e?.refClub,
        e?.cPname,
        e?.createdat,
        e?.lastupdatedAt,
  ...
  @override
  bool isValidKey(Object? o) => o is StaffLeadsRecord;
}
