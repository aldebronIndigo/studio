...
import 'create_contest_model.dart';
export 'create_contest_model.dart';

class CreateContestWidget extends StatefulWidget {
  const CreateContestWidget({
    super.key,
  ...
  static String routeName = 'createContest';
  static String routePath = '/createContest';

  @override
  State<CreateContestWidget> createState() => _CreateContestWidgetState();
}

class _CreateContestWidgetState extends State<CreateContestWidget>
    with TickerProviderStateMixin {
  late CreateContestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateContestModel());
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              try {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                    .hideCurrentSnackBar();
                                                _model.isDataUploading_uploadData33z =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadData33z =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadData33z =
                                                      downloadUrls.first;
                                                });
                                                showUploadMessage(
                                                    context, 'Success!');
                            ...
                            child: Row(
                              ...
                              children: [
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.particpantsValueController ??=
