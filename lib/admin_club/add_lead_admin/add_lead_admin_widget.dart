...
import 'add_lead_admin_model.dart';
export 'add_lead_admin_model.dart';

class AddLeadAdminWidget extends StatefulWidget {
  const AddLeadAdminWidget({
    super.key,
  ...
  static String routeName = 'addLeadAdmin';
  static String routePath = '/addLeadAdmin';

  @override
  State<AddLeadAdminWidget> createState() => _AddLeadAdminWidgetState();
}

class _AddLeadAdminWidgetState extends State<AddLeadAdminWidget>
    with TickerProviderStateMixin {
  late AddLeadAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddLeadAdminModel());
