...
import 'view_all_leads_model.dart';
export 'view_all_leads_model.dart';

class ViewAllLeadsWidget extends StatefulWidget {
  const ViewAllLeadsWidget({
    super.key,
  ...
  static String routeName = 'viewAllLeads';
  static String routePath = '/viewAllLeads';

  @override
  State<ViewAllLeadsWidget> createState() => _ViewAllLeadsWidgetState();
}

class _ViewAllLeadsWidgetState extends State<ViewAllLeadsWidget>
    with TickerProviderStateMixin {
  late ViewAllLeadsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewAllLeadsModel());
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      _model.leadStage = 'Hot';
                                      _model.filteredLeads = true;
                                      safeSetState(() {});
                                    },
                                    child: Material(
                            ...
                            if (_model.filteredLeads == false)
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (_model.filteredLeads == true)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 5.0, 0.0, 5.0),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  context.pushNamed(
                                                    ViewLeadNewWidget.routeName,
                                                    queryParameters: {
                                                      'refLead': serializeParam(
                                                        listViewLeadsRecord,
                                                        ParamType.Document,
                                                      ),
                                                    }.withoutNulls,
