...
import 'create_members_pass_model.dart';
export 'create_members_pass_model.dart';

class CreateMembersPassWidget extends StatefulWidget {
  const CreateMembersPassWidget({
    super.key,
  ...
  static String routeName = 'createMembersPass';
  static String routePath = '/createMembersPass';

  @override
  State<CreateMembersPassWidget> createState() =>
      _CreateMembersPassWidgetState();
}

class _CreateMembersPassWidgetState extends State<CreateMembersPassWidget>
    with TickerProviderStateMixin {
  late CreateMembersPassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateMembersPassModel());
