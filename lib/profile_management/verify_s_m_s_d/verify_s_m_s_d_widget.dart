...
import 'verify_s_m_s_d_model.dart';
export 'verify_s_m_s_d_model.dart';

class VerifySMSDWidget extends StatefulWidget {
  const VerifySMSDWidget({super.key});

  static String routeName = 'verifySMSD';
  static String routePath = '/verifySMSD';

  @override
  State<VerifySMSDWidget> createState() => _VerifySMSDWidgetState();
}

class _VerifySMSDWidgetState extends State<VerifySMSDWidget>
    with TickerProviderStateMixin {
  late VerifySMSDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifySMSDModel());
