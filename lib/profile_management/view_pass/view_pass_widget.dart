...
import 'view_pass_model.dart';
export 'view_pass_model.dart';

class ViewPassWidget extends StatefulWidget {
  const ViewPassWidget({
    super.key,
  ...
  static String routeName = 'viewPass';
  static String routePath = '/viewPass';

  @override
  State<ViewPassWidget> createState() => _ViewPassWidgetState();
}

class _ViewPassWidgetState extends State<ViewPassWidget>
    with TickerProviderStateMixin {
  late ViewPassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewPassModel());
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (widget.refPass?.transferable == true)
                                        Padding(
                                          padding:
