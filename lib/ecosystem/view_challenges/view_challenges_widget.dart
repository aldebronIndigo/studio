...
class ViewChallengesWidget extends StatefulWidget {
  ...
  static String routeName = 'viewChallenges';
  static String routePath = '/viewChallenges';
...
class _ViewChallengesWidgetState extends State<ViewChallengesWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.currentDate = functions.datetointeger(getCurrentTimestamp);
      safeSetState(() {});
    });
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            StreamBuilder<List<ContestsRecord>>(
                              stream: queryContestsRecord(
                                parent: widget.refClub?.reference,
                                queryBuilder: (contestsRecord) => contestsRecord
                                    .where(
                                      'dateRange',
                                      arrayContains: _model.currentDate,
                                    )
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ContestsRecord>
                                    listViewContestsRecordList = snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: listViewContestsRecordList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewContestsRecord =
                                        listViewContestsRecordList[
                                            listViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 5.0, 0.0, 5.0),
