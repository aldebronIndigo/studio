...
import 'create_staff_account_model.dart';
export 'create_staff_account_model.dart';

class CreateStaffAccountWidget extends StatefulWidget {
  const CreateStaffAccountWidget({
    super.key,
  ...
  static String routeName = 'createStaffAccount';
  static String routePath = '/createStaffAccount';

  @override
  State<CreateStaffAccountWidget> createState() =>
      _CreateStaffAccountWidgetState();
}

class _CreateStaffAccountWidgetState extends State<CreateStaffAccountWidget>
    with TickerProviderStateMixin {
  late CreateStaffAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateStaffAccountModel());
    ...
    _model.venueTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.venue, ''));
    ...
    _model.uploadResumeTextController ??= TextEditingController();
    _model.uploadResumeFocusNode ??= FocusNode();
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_model.radioButtonValue == 'Already Working')
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Padding(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.uploadResumeTextController,
                                          focusNode:
                                              _model.uploadResumeFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                          ...
                                          enableInteractiveSelection: true,
                                          validator: _model
                                              .uploadResumeTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedFiles != null) {
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataE0x =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            ...
                                            downloadUrls.length ==
                                                selectedFiles.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadDataE0x =
                                                selectedUploadedFiles.first;
                                            _model.uploadedFileUrl_uploadDataE0x =
                                                downloadUrls.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await StaffAccountsRecord.createDoc(
                                                widget.refClub!.reference)
                                            .set(createStaffAccountsRecordData(
