...
import 'add_lead_general_model.dart';
export 'add_lead_general_model.dart';

class AddLeadGeneralWidget extends StatefulWidget {
  const AddLeadGeneralWidget({
    super.key,
    required this.refStaff,
  });

  final StaffAccountsRecord? refStaff;

  static String routeName = 'addLeadGeneral';
  static String routePath = '/addLeadGeneral';

  @override
  State<AddLeadGeneralWidget> createState() => _AddLeadGeneralWidgetState();
}

class _AddLeadGeneralWidgetState extends State<AddLeadGeneralWidget>
    with TickerProviderStateMixin {
  late AddLeadGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddLeadGeneralModel());
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await StaffLeadsRecord.createDoc(
                                                      widget
                                                          .refStaff!.refClub!)
                                                  .set(
                                                      createStaffLeadsRecordData(
                                                refClub:
                                                    widget.refStaff?.refClub,
                                                cPname:
