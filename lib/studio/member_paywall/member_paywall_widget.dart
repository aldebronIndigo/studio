...
import 'member_paywall_model.dart';
export 'member_paywall_model.dart';

class MemberPaywallWidget extends StatefulWidget {
  const MemberPaywallWidget({super.key});

  static String routeName = 'memberPaywall';
  static String routePath = '/memberPaywall';

  @override
  State<MemberPaywallWidget> createState() => _MemberPaywallWidgetState();
}

class _MemberPaywallWidgetState extends State<MemberPaywallWidget>
    with TickerProviderStateMixin {
  late MemberPaywallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MemberPaywallModel());
