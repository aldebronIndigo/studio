...
import 'create_branch_model.dart';
export 'create_branch_model.dart';

class CreateBranchWidget extends StatefulWidget {
  const CreateBranchWidget({
    super.key,
  ...
  static String routeName = 'createBranch';
  static String routePath = '/createBranch';

  @override
  State<CreateBranchWidget> createState() => _CreateBranchWidgetState();
}

class _CreateBranchWidgetState extends State<CreateBranchWidget>
    with TickerProviderStateMixin {
  late CreateBranchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateBranchModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.foundSeq = await queryStudioSequencesRecordOnce(
        parent: widget.refStudio,
        singleRecord: true,
      ).then((s) => s.firstOrNull);
      _model.branchSeq = _model.foundSeq?.branchSeq;
      safeSetState(() {});
    });
    ...
    _model.introductionTextController ??= TextEditingController();
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  var branchRecordReference =
                                      BranchRecord.createDoc(
                                          widget.refStudio!);
                                  await branchRecordReference
                                    ...
                                    branchSeq: _model.branchSeq,
                                    status: _model.radioButtonValue,
                                  ));
                                  _model.branchCreated =
                                      BranchRecord.getDocumentFromData(
                                          createBranchRecordData(
                                            ...
                                            branchVenue:
                                                _model.venueTextController.text,
                                            branchAddress: _model
                                                .addressTextController.text,
                                            branchCity:
                                                _model.cityTextController.text,
                                            branchState:
                                                _model.stateTextController.text,
                                            branchCountry: _model
                                                .countryTextController.text,
                                            branchZipCode: _model
                                  ...
                                  await widget.refStudio!.update({
                                    ...mapToFirestore(
                                      {
                                        'refBranches': FieldValue.arrayUnion(
                                            [_model.branchCreated?.reference]),
                                      },
                                    ),
                                  });

                                  await _model.foundSeq!.reference.update({
                                    ...mapToFirestore(
                                      {
                                        'branchSeq': FieldValue.increment(1),
                                      },
                                    ),
                                  });
