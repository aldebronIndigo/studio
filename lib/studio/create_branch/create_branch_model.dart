...
import '/index.dart';
import 'create_branch_widget.dart' show CreateBranchWidget;
import 'package:flutter/material.dart';

class CreateBranchModel extends FlutterFlowModel<CreateBranchWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in createBranch widget.
