...
import '/index.dart';
import 'create_pass_widget.dart' show CreatePassWidget;
import 'package:flutter/material.dart';

class CreatePassModel extends FlutterFlowModel<CreatePassWidget> {
  ...
  bool isDataUploading_uploadDataFt4pass = false;
  FFUploadedFile uploadedLocalFile_uploadDataFt4pass =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataFt4pass = '';
  ...
  // State field(s) for waitlist widget.
  bool? waitlistValue;
