...
import 'edit_branch_model.dart';
export 'edit_branch_model.dart';

class EditBranchWidget extends StatefulWidget {
  const EditBranchWidget({
    super.key,
    required this.refBranch,
  });

  final BranchRecord? refBranch;

  static String routeName = 'editBranch';
  static String routePath = '/editBranch';

  @override
  State<EditBranchWidget> createState() => _EditBranchWidgetState();
}

class _EditBranchWidgetState extends State<EditBranchWidget>
    with TickerProviderStateMixin {
  late EditBranchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditBranchModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.location = widget.refBranch?.location;
      safeSetState(() {});
    });

    _model.branchNameTextController ??=
        TextEditingController(text: widget.refBranch?.branchName);
    _model.branchNameFocusNode ??= FocusNode();

    _model.introductionTextController ??=
        TextEditingController(text: widget.refBranch?.branchDescription);
    _model.introductionFocusNode ??= FocusNode();

    _model.phoneTextController ??=
        TextEditingController(text: widget.refBranch?.phoneNumber);
    _model.phoneFocusNode ??= FocusNode();

    _model.emailTextController ??=
        TextEditingController(text: widget.refBranch?.emailAddress);
    _model.emailFocusNode ??= FocusNode();

    _model.venueTextController ??=
        TextEditingController(text: widget.refBranch?.branchVenue);
    _model.venueFocusNode ??= FocusNode();

    _model.addressTextController ??=
        TextEditingController(text: widget.refBranch?.branchAddress);
    _model.addressFocusNode ??= FocusNode();

    _model.cityTextController ??=
        TextEditingController(text: widget.refBranch?.branchCity);
    _model.cityFocusNode ??= FocusNode();

    _model.stateTextController ??=
        TextEditingController(text: widget.refBranch?.branchState);
    _model.stateFocusNode ??= FocusNode();

    _model.countryTextController ??=
        TextEditingController(text: widget.refBranch?.branchCountry);
    _model.countryFocusNode ??= FocusNode();

    _model.zipCodeTextController ??=
        TextEditingController(text: widget.refBranch?.branchZipCode);
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          enableInteractiveSelection: true,
                                          validator: _model
                                              .introductionTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await widget.refBranch!.reference
                                      .update(createBranchRecordData(
                                    branchName:
                                    ...
                                    branchAddress:
                                        _model.addressTextController.text,
                                    branchCity: _model.cityTextController.text,
                                    branchState:
                                        _model.stateTextController.text,
                                    branchCountry:
                                        _model.countryTextController.text,
                                    ...
                                    branchDescription:
                                        _model.introductionTextController.text,
