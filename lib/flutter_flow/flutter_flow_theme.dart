...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF44044E);
  late Color secondary = const Color(0xFF5F0F40);
  late Color tertiary = const Color(0xFFFC4043);
  late Color alternate = const Color(0xFFFFCCD5);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF7F3F1);
  late Color accent1 = const Color(0xFF5F0F40);
  late Color accent2 = const Color(0xFF4EA8DE);
  late Color accent3 = const Color(0xFF56CFE1);
  late Color accent4 = const Color(0xFFFFBF69);
