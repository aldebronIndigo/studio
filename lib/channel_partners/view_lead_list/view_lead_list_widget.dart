...
import 'view_lead_list_model.dart';
export 'view_lead_list_model.dart';

class ViewLeadListWidget extends StatefulWidget {
  const ViewLeadListWidget({
    super.key,
    required this.refCP,
  });
  ...
  static String routeName = 'viewLeadList';
  static String routePath = '/viewLeadList';

  @override
  State<ViewLeadListWidget> createState() => _ViewLeadListWidgetState();
}

class _ViewLeadListWidgetState extends State<ViewLeadListWidget>
    with TickerProviderStateMixin {
  late ViewLeadListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewLeadListModel());
                              ...
                              children: [
                                StreamBuilder<List<LeadsRecord>>(
                                  stream: queryLeadsRecord(
                                    parent: widget.refCP?.refClub,
                                    queryBuilder: (leadsRecord) => leadsRecord
                                        .where(
                                          'refCP',
                                          isEqualTo: widget.refCP?.reference,
                                        )
                                        .orderBy('createdat'),
                                  ),
