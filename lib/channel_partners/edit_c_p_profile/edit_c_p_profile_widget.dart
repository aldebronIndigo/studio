...
import 'edit_c_p_profile_model.dart';
export 'edit_c_p_profile_model.dart';

class EditCPProfileWidget extends StatefulWidget {
  const EditCPProfileWidget({
    super.key,
    required this.refCP,
  });
  ...
  static String routeName = 'editCPProfile';
  static String routePath = '/editCPProfile';

  @override
  State<EditCPProfileWidget> createState() => _EditCPProfileWidgetState();
}

class _EditCPProfileWidgetState extends State<EditCPProfileWidget>
    with TickerProviderStateMixin {
  late EditCPProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCPProfileModel());
    ...
    _model.venueTextController ??=
        TextEditingController(text: widget.refCP?.officeVenue);
    _model.venueFocusNode ??= FocusNode();

    _model.addressTextController ??=
        TextEditingController(text: widget.refCP?.officeAddress);
    _model.addressFocusNode ??= FocusNode();

    _model.cityTextController ??=
        TextEditingController(text: widget.refCP?.officecity);
    _model.cityFocusNode ??= FocusNode();

    _model.stateTextController ??=
        TextEditingController(text: widget.refCP?.officeState);
    _model.stateFocusNode ??= FocusNode();

    _model.countryTextController ??=
        TextEditingController(text: widget.refCP?.officeCountry);
    _model.countryFocusNode ??= FocusNode();

    _model.pinCodeTextController ??=
        TextEditingController(text: widget.refCP?.officeZipCode);
    _model.pinCodeFocusNode ??= FocusNode();

    _model.offEmailTextController ??=
        TextEditingController(text: widget.refCP?.officeEmail);
    _model.offEmailFocusNode ??= FocusNode();

    _model.offPhoneTextController ??=
        TextEditingController(text: widget.refCP?.addcontactNumber);
    _model.offPhoneFocusNode ??= FocusNode();

    _model.websiteTextController ??=
        TextEditingController(text: widget.refCP?.website);
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await widget.refCP!.reference.update(
                                            createChannelPartnersRecordData(
                                          fullName: _model
                                          ...
                                          officeZipCode:
                                              _model.pinCodeTextController.text,
                                          officeEmail: _model
                                              .offEmailTextController.text,
                                          addcontactNumber: _model
                                              .offPhoneTextController.text,
                                          website:
                                              _model.websiteTextController.text,
                                        ));

                                        context.pushNamed(
                                          ViewChannelPartnerNewWidget.routeName,
                                          queryParameters: {
                                            'refchannelPartner': serializeParam(
                                              widget.refCP,
                                              ParamType.Document,
                                            ),
                                          }.withoutNulls,
                                          extra: <String, dynamic>{
                                            'refchannelPartner': widget.refCP,
                                          },
                                        );
                                      },
                                      text: 'Update Profile',
