...
import 'add_leadnew_model.dart';
export 'add_leadnew_model.dart';

class AddLeadnewWidget extends StatefulWidget {
  const AddLeadnewWidget({
    super.key,
    required this.refCP,
  });
  ...
  static String routeName = 'addLeadnew';
  static String routePath = '/addLeadnew';

  @override
  State<AddLeadnewWidget> createState() => _AddLeadnewWidgetState();
}

class _AddLeadnewWidgetState extends State<AddLeadnewWidget>
    with TickerProviderStateMixin {
  late AddLeadnewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddLeadnewModel());
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await LeadsRecord.createDoc(
                                                      widget.refCP!.refClub!)
                                                  .set(createLeadsRecordData(
                                                refClub: widget.refCP?.refClub,
                                                refCP: widget.refCP?.reference,
                                                cPname: widget.refCP?.fullName,
                                                ...
                                                leadStage: _model.dropDownValue,
                                                noteadded: false,
