...
class SubmitRequestWidget extends StatefulWidget {
  const SubmitRequestWidget({super.key});

  static String routeName = 'submitRequest';
  static String routePath = '/submitRequest';
                ...
                children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData3xym = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadData3xym =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData3xym =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadData3xym =
                                          downloadUrls.first;
                                    });
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await SupportTicketsGeneralRecord.collection
                            .doc()
                            .set(createSupportTicketsGeneralRecordData(
                              refuser: currentUserReference,
                              username: _model.textController1.text,
                              screenshot: _model.uploadedFileUrl_uploadData3xym,
                              userEmail: _model.textController2.text,
