...
class SubmitBugWidget extends StatefulWidget {
  ...
  static String routeName = 'submitBug';
  static String routePath = '/submitBug';
                ...
                children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData3xy = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadData3xy =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData3xy =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadData3xy =
                                          downloadUrls.first;
                                    });
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await SupportTicketsRecord.createDoc(
                                widget.refClub!.reference)
                            .set(createSupportTicketsRecordData(
                          userRef: currentUserReference,
                          userName: _model.textController1.text,
                          userEmailID: _model.textController2.text,
                          screenshot: _model.uploadedFileUrl_uploadData3xy,
                          description: _model.textController3.text,
                          createdAt: getCurrentTimestamp,
                          addressedTo: widget.refClub?.superadminRef,
