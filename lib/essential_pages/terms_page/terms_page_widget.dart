                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue) {
                                context.pushNamed(CookiePolicyWidget.routeName);
                              }
                            },
                            title: Text(
                              'Cookie Policy',
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue) {
                                context
                                    .pushNamed(AcceptableUseWidget.routeName);
                              }
                            },
                            title: Text(
                              'Acceptable Usage',
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue) {
                                context
                                    .pushNamed(EulaAgreementWidget.routeName);
                              }
                            },
                            title: Text(
                              'EULA Agreement',
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue) {
                                context
                                    .pushNamed(IpandDMAPolicyWidget.routeName);
                              }
                            },
                            title: Text(
                              'IP & DMA Policy',
