...
class ViewGroupWidget extends StatefulWidget {
  ...
  static String routePath = '/viewGroup';
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final membersearkly =
                                      (widget.refGroup?.members.toList() ??
                                              [])
                                          .take(5)
                                          .toList();
                                  ...
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(membersearkly.length,
                                            (membersearklyIndex) {
                                      final membersearklyItem =
                                          membersearkly[membersearklyIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 8.0, 0.0),
                                        child: Material(
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 8.0, 0.0, 8.0),
                              child: StreamBuilder<List<GroupEventsRecord>>(
                                stream: queryGroupEventsRecord(
                                  parent: widget.refClub?.reference,
                                  queryBuilder: (groupEventsRecord) =>
                                      groupEventsRecord.where(
                                    'refGroup',
                                    isEqualTo: widget.refGroup?.reference,
                                  ),
                                  limit: 3,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<GroupEventsRecord>
                                      rowGroupEventsRecordList = snapshot.data!;

                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(
                                        rowGroupEventsRecordList.length,
                                        (rowIndex) {
                                      final rowGroupEventsRecord =
                                          rowGroupEventsRecordList[rowIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            5.0, 5.0, 5.0, 5.0),
                                        child: Material(
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                rowGroupEventsRecord.eventName,
